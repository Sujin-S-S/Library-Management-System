...
def returnBook():
    ...
    SubmitBtnr.place(x=200, y=180)

    SubmitBtnr = Button(labelFrame, text="Generate Fine", bg='white', fg='black', width=10, height=2, command=fine)
    SubmitBtnr.place(x=400, y=180)
